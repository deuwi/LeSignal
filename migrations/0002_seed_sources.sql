-- Seed sources. Voir SOURCES.md. Idempotent via nom unique logique.
DELETE FROM sources;
...
('atom','Bun releases','https://github.com/oven-sh/bun/releases.atom','dev',3,NULL,1),
('atom','Deno releases','https://github.com/denoland/deno/releases.atom','dev',3,NULL,1),
-- IA outillage (both)
...
('atom','MCP releases','https://github.com/modelcontextprotocol/modelcontextprotocol/releases.atom','both',3,NULL,1),
('atom','Simon Willison','https://simonwillison.net/atom/everything/','both',2,NULL,1),
('search','Cursor changelog','Cursor editor changelog release','both',3,'{"query":"Cursor editor changelog release features"}',0),
('search','OpenAI Codex news','OpenAI Codex coding agent release','both',3,'{"query":"OpenAI Codex coding agent release"}',0),
-- web / cloud
('rss','Cloudflare blog','https://blog.cloudflare.com/rss/','dev',3,NULL,1),
('rss','React blog','https://react.dev/rss.xml','dev',3,NULL,1),
('rss','web.dev','https://web.dev/static/blog/feed.xml','dev',2,NULL,1),
-- archi / études
('rss','arXiv cs.SE','https://rss.arxiv.org/rss/cs.SE','both',3,NULL,1),
('rss','arXiv cs.DC','https://rss.arxiv.org/rss/cs.DC','dev',3,NULL,1),
...
('api','France Travail tensions','francetravail.io','deuwi',3,'{"kind":"francetravail","rome":["M1805","M1802"],"needs_secret":true}',0),
('search','Free-Work marché','Free-Work marché freelance développeur IA','deuwi',2,'{"query":"Free-Work marché freelance développeur IA France"}',0),
('scrape','APEC études','https://corporate.apec.fr/toutes-nos-etudes','deuwi',3,NULL,0);
